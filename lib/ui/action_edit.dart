...
class _ActionEditState extends State<ActionEdit> {
  ...
  void initState() {
    super.initState();
    if (widget.actionsModel != null) {
      setState(() {
        isEnableName = false;
        isEnableSaveName = false;
        _textEditingControllerName.text = widget.actionsModel.action;
        name = widget.actionsModel.action;
        print(
            '${widget.actionsModel} ${widget.actionsModel.element} : ${widget.actionsModel.point}');
        elementList = widget.actionsModel.element;
        pointList = widget.actionsModel.point;
      });
    }
  }
            ...
            leading: IconButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => AddActionScreen()));
              },
            ),
